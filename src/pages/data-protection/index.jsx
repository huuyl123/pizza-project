    ...
    <div className={styles.container}>
      ...
      <div className={styles.mt1}>
        ...
        <p>
          ...
          by Google Inc. &quotes;Google&quotes;. Google Analytics uses so-called
          "cookies", text files that are stored on your computer and enable an
          ...
          to do so by law or if third parties process this data on Google's
          behalf. Under no circumstances will Google associate your IP address
          with other data held by Google Inc. You can prevent the installation
          of cookies by setting your browser software accordingly; we would like
          to point out to you however that in this case you can if applicable
          not use all functions of this website in full. By using this website,
